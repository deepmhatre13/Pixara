      ...
      >
        <div className="glass dark:glass-dark rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            >
              Sign in to your PixaraX account
            </motion.p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {error && (
              <motion.div
                ...
                className="bg-red-100 dark:bg-red-900/20 border border-red-300 dark:border-red-700 text-red-700 dark:text-red-400 px-4 py-3 rounded-lg text-sm"
              >
                {error}
              </motion.div>
            )}
